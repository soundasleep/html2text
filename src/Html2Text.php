...
class Html2Text {
	 ...
	 * by a browser.
	 */
	static function renderText(string $text): string {
	...
	static function nextChildName($node): ?string {
		// get the next child
	...
	static function iterateOverNode($node, $prevName, bool $in_pre, bool $is_office_document, $options): string {
