...
class Html2Text {
	 ...
	 */
	public static function convert(string $html, $options = []) {
	 ...
	 */
	static function fixNewlines(string $text) {
		// replace \r\n to \n
		$text = str_replace("\r\n", "\n", $text);
		// remove \rs
		$text = str_replace("\r", "\n", $text);
	 ...
	 * @return string the fixed text
	 */
	static function processWhitespaceNewlines(string $text) {
	 ...
	 */
	static function getDocument(string $html, bool $ignore_error = false) {
	 ...
	 */
	static function isOfficeDocument(string $html) {
	 ...
	 * by a browser.
	 */
	static function renderText(string $text) {
		$text = str_replace(static::nbspCodes(), " ", $text);
		$text = str_replace(static::zwnjCodes(), "", $text);
		return $text;
	}

	static function isWhitespace(string $text) {
	...
	static function iterateOverNode($node, $prevName, bool $in_pre, bool $is_office_document, $options) {
